...
| **P3** — manifest modernization | ✅ Done (2026-06-10) | build + manifest inspection | `id`, `display_override`, `launch_handler`, `categories`, 3 `shortcuts`, 2 `screenshots` (`dashboard-wide.png` 1280x800 wide, `dashboard-narrow.png` 390x844 narrow, captured via Playwright against preview) |
